...
pipelineJob('eric-enm-int-esm-server-prepare') {
            ...
            scm {
                git {
                    ...
                    remote {
                        ...
                        url("ssh://gerrit-gamma.gic.ericsson.se:29418/OSS/ENM-Parent/SQ-Gate/com.ericsson.oss.containerisation/eric-enm-int-esm-server")
                    }
                    extensions {
                         cleanBeforeCheckout()
                    }
...
pipelineJob('eric-enm-int-esm-server-test') {
...
pipelineJob('eric-enm-int-esm-server-publish') {
...
pipelineJob('Spinnaker_ENM_APP_STAGING_ESM_SERVER_Updater') {
